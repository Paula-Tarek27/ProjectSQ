...
class Account
{
    ...
    public function updateDetails($fn, $ln, $em, $un)
    {
        ...
        if (empty($this->errorArray)) {
            $query = $this->con->prepare("UPDATE users SET firstNmae=:fn, lastName=:ln, email=:em
                                            WHERE userName=:un");
    ...
    private function insertUserDetails($fn, $ln, $un, $em, $pw)
    {
        ...
        $query = $this->con->prepare("INSERT INTO users (firstNmae, lastName, userName, email, password)
